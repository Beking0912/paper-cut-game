...
var steps : [Step] = [
    ...
    Step(image: "step3", title: "Step 3", description: "Fold it into thirds.",color: Color("Red")),
    ...
    Step(image: "step7", title: "Step 7", description: "Unfold the paper, revealing a symmetrical design.",color: Color("Red")),
