...
var intros : [Intro] = [
    ...
    Intro(image: "startgame", title: "Unveiling Symmetry", description: "Let's dive into the interactive adventure of folding and cutting paper. Together, we'll unravel the mystery and make predictions about the symmetrical design that will unfold from our folded creations. Can you discover the correct pattern? Give it a try!",color: Color("Red")),
]
